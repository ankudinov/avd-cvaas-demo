...
| --- | ---- | ---- | ------------- | -------- | -------------------------- | ------------- |
| AVD_FABRIC | l3leaf | leaf1 | 192.168.0.12/24 | cEOS | Provisioned | - |
| AVD_FABRIC | l3leaf | leaf2 | 192.168.0.13/24 | cEOS | Provisioned | - |
| AVD_FABRIC | spine | spine1 | 192.168.0.10/24 | cEOS | Provisioned | - |
| AVD_FABRIC | spine | spine2 | 192.168.0.11/24 | cEOS | Provisioned | - |
...
| POD | Node | Loopback0 |
| --- | ---- | --------- |
| AVD_FABRIC | leaf1 | 192.0.255.3/32 |
| AVD_FABRIC | leaf2 | 192.0.255.4/32 |
...
| POD | Node | Loopback1 |
| --- | ---- | --------- |
| AVD_FABRIC | leaf1 | 192.0.254.3/32 |
| AVD_FABRIC | leaf2 | 192.0.254.3/32 |
